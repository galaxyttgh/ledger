...
const EmployeeForm = () => {
  ...
  const handleCancel = () => {
    const hasData = firstName || lastName || email || phone || basicSalary || 
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Add Employee</h2>
              <p className="text-gray-500 mt-1 text-sm">Create a new employee record</p>
            </div>
            <button 
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
            ...
            {/* Allowances - Stack on mobile, 3 columns on desktop */}
