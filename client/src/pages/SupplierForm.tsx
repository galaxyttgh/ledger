...
//             <p className="text-gray-500 mt-1">Create a new supplier account</p>
//           </div>
//           <button onClick={() => navigate('/suppliers')} className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50">
//             ← Back
//           </button>
//         </div>
...
//             <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required />
//           </div>
//           <div className="mb-4">
//             <label className="block text-sm font-medium text-gray-700 mb-1">Email</label>
//             <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
//           </div>
//           <div className="mb-4">
//             <label className="block text-sm font-medium text-gray-700 mb-1">Phone</label>
//             <input type="text" value={phone} onChange={(e) => setPhone(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
//           </div>
//           <div className="mb-6">
...
const SupplierForm = () => {
  ...
  const handleCancel = () => {
    if (name || email || phone || address || taxId) {
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Add Supplier</h2>
              <p className="text-gray-500 mt-1 text-sm">Create a new supplier account</p>
            </div>
            <button 
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-4 lg:p-6">
          ...
          {name && (
            <div className="mb-6 p-3 bg-blue-50 rounded-xl">
              <h4 className="text-xs font-semibold text-blue-900 mb-2">Supplier Preview</h4>
              <div className="space-y-1 text-sm">
                ...
                <p className="text-blue-600 text-xs">Payment: {paymentTerms === '0' ? 'Due on receipt' : `Net ${paymentTerms} days`}</p>
              </div>
            </div>
          )}
